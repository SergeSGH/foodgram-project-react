    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(choices=[('#00FF00', 'Лимонный'), ('#9400D3', 'Темно-фиолетовый'), ('#008000', 'Зеленый'), ('#00BFFF', 'Голубой')], help_text='Цвет', max_length=7, unique=True, verbose_name='Цвет')),
            ],
            options={
                'verbose_name': 'Тэг',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.DecimalField(decimal_places=1, help_text='Количество', max_digits=4, verbose_name='Количество')),
